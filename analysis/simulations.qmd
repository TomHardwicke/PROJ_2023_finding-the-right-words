...
pb <- .05 # the probability of a positive response only in the test individual in the pair (pb)
pc <- .15 # the probability of a positive response only in the control individual in the pair (pc)
